...
model = torch.load('./transformer_280.pth')
# print("--------model=",model)
...
print('----loader=',loader)
print('----next_iter_loader1=',next(iter(loader)))
print('----next_iter_loader2=',next(iter(loader)))
print('----next_iter_loader3=',next(iter(loader)))
enc_inputs, _, _ = next(iter(loader))
enc_inputs=torch.tensor([[1, 2, 3, 4, 0]])
print('----enc_inputs=',enc_inputs,'----------enc_inputs.shape=',enc_inputs.shape)
